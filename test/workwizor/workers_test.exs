defmodule Workwizor.WorkersTest do
  ...
  describe "workers" do
    ...
    @valid_attrs %{avatar_url: "some avatar_url", first_name: "some first_name", last_name: "some last_name"}
    @update_attrs %{avatar_url: "some updated avatar_url", first_name: "some updated first_name", last_name: "some updated last_name"}
    ...
    test "create_worker/1 with valid data creates a worker" do
      ...
      assert worker.avatar_url == "some avatar_url"
    ...
    test "update_worker/2 with valid data updates the worker" do
      ...
      assert worker.avatar_url == "some updated avatar_url"
